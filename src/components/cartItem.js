                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                    <div>
                                        <div className="flex justify-between text-base font-medium text-gray-900">
                                            ...
                                            <p className="ml-4">Rp. {item.price * item.quantity}</p>
                                        </div>
                                    ...
                                    <div className="flex flex-1 items-end justify-between text-sm">
                                        <div className="flex items-center">
                                            ...
                                            {/* <button > - </button> */}
                                            {/* <span className="ml-2 w-10 border text-center">{item.quantity}</span> */}
                                            <input className="ml-2 w-20 text-center" type='number' min='1' value={item.quantity} onChange={handleQuantityChange} />
