...
export default function Pagination() {
    return (
        <div className="flex relative items-center justify-between bg-transparent px-4 py-3 sm:px-6">
                ...
                <div className='md:pr-20'>
                    <nav className="isolate  inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        ...
                        <a
                            href="home"
                            aria-current="page"
                            className="relative z-10 inline-flex items-center bg-amber-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600"
                        >
                            1
                        </a>
                        <a
