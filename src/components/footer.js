        ...
        <footer className="bg-gray-900/50 py-6 h-28 mt-5">
            <div className="container mx-auto  text-center items-center">
                <p className="text-gray-200 text-sm pb-7">
                    Hampir semua konten dalam website ini (logo, gambar, menu) merupakan jiplakan dari website resmi <a href="https://dapursolo.com/" className="text-amber-500">Dapur Solo</a>.
